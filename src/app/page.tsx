  ...
  return (
    <SmoothScroll>
      <div ref={containerRef} className="relative min-h-screen selection:bg-purple-500/30">
        ...
        {/* Agency Teaser */}
        <section className="relative py-40 px-4 md:px-20 z-10 text-center" data-scroll-section>
          <div className="max-w-3xl mx-auto p-12 rounded-[3rem] bg-gradient-to-b from-purple-500/10 to-transparent border border-white/5 reveal-text">
