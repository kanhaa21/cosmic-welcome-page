      ...
      <div ref={contentRef} className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 text-center">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            <Link 
              href="/"
              className="px-10 py-5 rounded-full bg-white text-black font-black text-xs uppercase tracking-widest hover:bg-purple-500 hover:text-white transition-all duration-500 hover:scale-110 active:scale-95"
            >
              Back to Earth
            </Link>
            <button 
            ...
            >
              <span className="group-hover:text-purple-400 transition-colors">Observe Stars</span>
            </button>
          </div>
        </div>

        {/* Sensory Data Overlays */}
        <div ref={statsRef} className="absolute bottom-12 left-12 text-left hidden md:block border-l border-purple-500/30 pl-6 py-2">
          <div className="flex items-center gap-3 mb-4 stat-item">
            ...
            <div className="flex flex-col">
              <span className="text-purple-500/40 font-mono text-[8px] uppercase tracking-[0.3em]">Star Density</span>
              <span className="text-white font-mono text-xs">400 BILLION</span>
            </div>
          </div>
          <div className="flex items-center gap-3 stat-item">
            ...
            <div className="flex flex-col">
              <span className="text-blue-500/40 font-mono text-[8px] uppercase tracking-[0.3em]">Galactic Rotation</span>
              <span className="text-white font-mono text-xs">230 KM/S</span>
            </div>
          </div>
        </div>
      </div>
