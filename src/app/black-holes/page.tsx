      ...
      <section ref={infoRef} className="relative z-10 min-h-screen py-32 px-4 md:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-32 grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
            ...
            <div className="relative aspect-square rounded-full border border-purple-500/20 flex items-center justify-center">
              <div className="absolute inset-0 animate-spin-slow rounded-full border border-dashed border-purple-500/10" />
