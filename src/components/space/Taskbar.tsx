...
export function Taskbar() {
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-4 md:top-8 left-1/2 -translate-x-1/2 z-50 px-4 md:px-6 py-3 md:py-4 rounded-full border border-white/5 bg-[#030014]/60 backdrop-blur-2xl flex items-center shadow-[0_20px_50px_-12px_rgba(0,0,0,0.8)] transition-all duration-200 hover:border-white/10 w-auto justify-center overflow-hidden group ${isHovered ? 'gap-3 md:gap-8' : 'gap-0'}`}
    >
