  ...
  if (isAgencyPage) {
    ...
    return (
      <motion.nav
        ...
        className="fixed top-6 left-1/2 -translate-x-1/2 z-50 rounded-full border border-white/5 bg-[#030014]/80 backdrop-blur-3xl flex items-center shadow-[0_30px_60px_-12px_rgba(0,0,0,0.9)] hover:border-white/10 transition-colors duration-500"
        style={{ 
          padding: isHovered ? "0.6rem 2rem" : "0.6rem 1.5rem",
        }}
        transition={{
