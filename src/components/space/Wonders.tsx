  ...
  return (
    <section className="relative py-32 px-4 md:px-20 z-10" data-scroll-section>
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col items-center text-center mb-20 reveal-text">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {wonders.map((item, i) => (
            <div
              key={item.title}
              className="group relative p-10 rounded-[3rem] glass-card border-white/5 transition-all duration-700 hover:bg-white/[0.04] reveal-text overflow-hidden"
              data-scroll
